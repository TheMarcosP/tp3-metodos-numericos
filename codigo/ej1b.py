...
def plot_compresion_lost_hist(filepath, k=10, savename = 'img_comprimida.pdf'):
    ...
    plt.plot( valores, label= 'error de compresión')
    plt.semilogy()
    plt.axhline(y=5, color='r', linestyle='--', label='5% de error')
    plt.legend()

    # reducir la tamaño de letra del eje x
...
if __name__ == '__main__':
    ...
    # tercer figura
    plot_compresion_lost_hist("dataset_imagenes\img02.jpeg", 28, 'error_de_compresion_nohist_1.pdf')
